...
return new class extends Migration
{
    ...
    {
        DB::statement("
            CREATE MATERIALIZED VIEW product_list_views
            AS
            select
            p.id,
            p.image,
        ...
        DB::statement("REFRESH MATERIALIZED VIEW product_list_views");
    }
    ...
    {
        DB::statement('DROP VIEW IF EXISTS product_list_views');
    }
};
